  ...
  return (
    <div className="prose dark:prose-invert">
      <div className="flex flex-col sm:flex-row-reverse items-start sm:mt-8">
        ...
        I'm studying Systems Engineering at UTN, a 5-year degree with a strong emphasis on software engineering, and I expect to graduate at the end of next year. I'm from Córdoba, Argentina. 
        </p>
        <p>
        I have some experience with Machine Learning, Data Science and Software Engineering.
        </p>
        </div>
      </div>      
      {/*
