...
export default function Home() {
  ...
  return (
    <div className="prose dark:prose-invert">
      <div className="flex flex-col sm:flex-row-reverse fade-in items-start sm:mt-8">
        <div className="w-full sm:-ml-8">
          <Image
            src="/tomasmalamud.jpg"
            className="rounded-full bg-neutral-100 hover:scale-105 hover:shadow-lg hover:shadow-stone-300 dark:hover:shadow-neutral-800 transition-all duration-200 float-left sm:float-right block mx-auto sm:mx-0 border border-neutral-300 dark:border-neutral-700"
            width={150}
            height={150}
